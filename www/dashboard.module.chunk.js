...
module.exports = "<div class=\"{{botFeeling}}\">\n    <app-hal \n        id=\"smallHal\" class=\"flexBox\"\n        [halSentence]=\"halSentence\"  \n        [ngClass]=\"{ 'close': userRegistration, 'shut': botShutUp }\" \n        [vuePath]=\"'/'\"\n        (changeVue)=\"proceedChangeVue($event)\" \n        (nextStep)=\"proceedNextStep($event)\" \n    ></app-hal>\n</div>\n\n<app-chatbot \n    [ngClass]=\"{ 'open': showNextStep }\" \n    (sendBotFeeling)=\"changeBotFeeling($event)\"\n></app-chatbot>"
...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.proceedNextStep = function (event) {
        this.showNextStep = event;
    };
    ;
    // Méthode pour définir l'état du Bot
    DashboardComponent.prototype.changeBotFeeling = function (event) {
        this.botFeeling = event;
    };
    ;
    // Méthode pour changer de route
    DashboardComponent.prototype.proceedChangeVue = function (event) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dashboard_route__ = __webpack_require__("../../../../../src/app/dashboard/dashboard.route.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__partials_chatbot_chatbot_module__ = __webpack_require__("../../../../../src/app/partials/chatbot/chatbot.module.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
DashboardModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
        ...
        imports: [__WEBPACK_IMPORTED_MODULE_2__dashboard_route__["a" /* Routing */], __WEBPACK_IMPORTED_MODULE_1__angular_common__["b" /* CommonModule */], __WEBPACK_IMPORTED_MODULE_4__partials_hal_hal_module__["a" /* HalModule */], __WEBPACK_IMPORTED_MODULE_5__partials_chatbot_chatbot_module__["a" /* ChatbotModule */]]
    })
    // Export de la CLASS du module
], DashboardModule);
...
/***/ "../../../../../src/app/partials/chatbot/chatbot.component.html":
/***/ (function(module, exports) {

module.exports = "<section id=\"conversation\">\n  <article class=\"user\" [innerHTML]=\"DomUserMessage\"  [ngClass]=\"{'open': newUserMessage}\"></article>\n  <article class=\"bot\" [innerHTML]=\"DomBotMessage\" [ngClass]=\"{'open': newMessage}\"></article>\n</section>\n\n<form action=\"#\" (submit)=\"submitForm()\" id=\"messageForm\">\n  <input name=\"userMessage\" [(ngModel)]=\"userMessage.content\" autofocus>\n  <button type=\"submit\">OK</button>\n</form>"

/***/ }),

/***/ "../../../../../src/app/partials/chatbot/chatbot.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ChatbotComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_recast_service__ = __webpack_require__("../../../../../src/app/services/recast.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChatbotComponent = (function () {
    function ChatbotComponent(myService) {
        this.myService = myService;
        this.DomUserMessage = null;
        this.conversation = [];
        this.activeUserIntent = null;
        this.newMessage = false;
        this.newUserMessage = false;
        // Envoyer des données dans le composant parent
        this.sendBotFeeling = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* EventEmitter */];
        this.userMessage = { id: 'user', content: '' };
        this.botMessage = { id: 'bot', content: '' };
    }
    ;
    ChatbotComponent.prototype.displayNewBotMessage = function (sentence) {
        var _this = this;
        this.newMessage = false;
        setTimeout(function () {
            _this.DomBotMessage = sentence;
            setTimeout(function () { return _this.newMessage = true; }, 10);
        }, 400);
    };
    ChatbotComponent.prototype.displayNewUserMessage = function (sentence) {
        var _this = this;
        this.newUserMessage = false;
        setTimeout(function () {
            _this.DomUserMessage = sentence;
            setTimeout(function () { return _this.newUserMessage = true; }, 10);
        }, 100);
    };
    ChatbotComponent.prototype.submitForm = function () {
        var _this = this;
        var tempMessage = { id: 'user', content: this.userMessage.content, intent: '' };
        this.conversation.push(tempMessage);
        this.displayNewUserMessage(this.userMessage.content);
        tempMessage = null;
        this.myService.getIndent(this.userMessage.content).then(function (data) {
            var subject = data.intentSubject;
            if (_this.activeUserIntent === 'get-news-complete') {
                switch (data.intent) {
                    case "yes":
                        _this.myService.getGoogleNews(subject).then(function (data) {
                            var tempNews = "Voila ce que j'ai trouve avec GoogleNews : <br><ul>";
                            ...
                            _this.conversation.push(tempMessage);
                            _this.displayNewBotMessage(tempMessage.content);
                            tempMessage = null;
                            _this.userMessage.content = '';
                            _this.activeUserIntent = null;
                        });
                        break;
                    default:
                        _this.displayNewBotMessage("Je n'ai pas bien compris alors, vous pouvez r\u00E9p\u00E9ter votre demande ?");
                        _this.userMessage.content = '';
                        _this.activeUserIntent = null;
                        break;
                }
            }
            else if (_this.activeUserIntent === 'get-weather-complete') {
                switch (data.intent) {
                    case "yes":
                        _this.myService.getWeather(subject).then(function (data) {
                            ...
                            var fiveDays = data[0].forecast;
                            tempNews += "<p class=\"fiveDaysTitle\">Evolution sur 5 jours</p>";
                            tempNews += "<div class=\"fiveDays\">";
                            for (var _i = 0, fiveDays_1 = fiveDays; _i < fiveDays_1.length; _i++) {
                                var item = fiveDays_1[_i];
            ...
            else if (_this.activeUserIntent === 'get-movie-complete') {
                switch (data.intent) {
                    case "yes":
                        var subject_1 = data.intentSubject;
                        _this.myService.getMovieList(subject_1).then(function (data) {
                            var movieArray = data.feed.movie;
                            console.log(movieArray);
                            var tempNews = "J'ai trouv\u00E9 " + movieArray.length + " film(s) : <br><ul>";
                            // Boucle sur la liste de film
                            for (var _i = 0, movieArray_1 = movieArray; _i < movieArray_1.length; _i++) {
                                var item = movieArray_1[_i];
                                tempNews += "<li class=\"movieItemList\">";
                                if (item.poster) {
                                    tempNews += "<img src=\"" + item.poster.href + "\">";
                                }
                                ;
                                tempNews += "<span class=\"movieTitle\"><b>\"" + item.originalTitle + "\"</b>";
                                if (item.castingShort) {
                                    if (item.castingShort.directors) {
                                        tempNews += "R\u00E9alis\u00E9 par " + item.castingShort.directors + " en " + item.productionYear + " ";
                                    }
                                    ;
                                    if (item.castingShort.actors) {
                                        tempNews += "avec " + item.castingShort.actors + ".";
                                    }
                                    ;
                                }
                                ;
                                tempNews += "</span> ";
                                if (item.link) {
                                    tempNews += "<a href=\"" + item.link[0].href + "\" target=\"_blank\">En savoir +</a>";
                                }
                                ;
                            }
                            tempNews += "</ul>";
            ...
            else if (_this.activeUserIntent === 'want-drink-complete') {
                switch (data.intent) {
                    case "yes":
                        _this.displayNewBotMessage("Tr\u00E8s bien je vous pr\u00E9pare votre boisson tout de suite.");
                        _this.userMessage.content = '';
                        _this.activeUserIntent = null;
                        break;
                    default:
                ...
                _this.sendBotFeeling.emit(data.feeling);
                _this.activeUserIntent = data.intent;
                _this.conversation.push(tempMessage);
                _this.displayNewBotMessage(tempMessage.content);
                tempMessage = null;
                _this.userMessage.content = '';
...
], ChatbotComponent.prototype, "sendBotFeeling", void 0);
ChatbotComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        selector: 'app-chatbot',
        template: __webpack_require__("../../../../../src/app/partials/chatbot/chatbot.component.html"),
        providers: [__WEBPACK_IMPORTED_MODULE_1__services_recast_service__["a" /* RecastService */]]
    }),
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__services_recast_service__["a" /* RecastService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_recast_service__["a" /* RecastService */]) === "function" && _b || Object])
], ChatbotComponent);
...
/***/ "../../../../../src/app/partials/chatbot/chatbot.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__chatbot_component__ = __webpack_require__("../../../../../src/app/partials/chatbot/chatbot.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_recast_service__ = __webpack_require__("../../../../../src/app/services/recast.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
ChatbotModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
        exports: [__WEBPACK_IMPORTED_MODULE_3__chatbot_component__["a" /* ChatbotComponent */]],
        declarations: [__WEBPACK_IMPORTED_MODULE_3__chatbot_component__["a" /* ChatbotComponent */]],
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_4__services_recast_service__["a" /* RecastService */]]
    })
], ChatbotModule);
...
/***/ "../../../../../src/app/services/recast.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RecastService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
...
var RecastService = (function () {
    ...
    RecastService.prototype.getGoogleNews = function (userSubject) {
    ...
    RecastService.prototype.getWeather = function (userSubject) {
    ...
    RecastService.prototype.getMovieList = function (userSubject) {
    ...
    RecastService.prototype.getDataFromApi = function (res) {
        return res.json() || {};
    };
    ;
    // Créer une fonction pour traiter les erreurs de requête
    RecastService.prototype.handleError = function (err) {
        return Promise.reject(err);
    };
    ;
    return RecastService;
}());
RecastService = __decorate([
...
var _a;
// 
//# sourceMappingURL=recast.service.js.map
